function [A,T,E] = GravEGM96(t,y,data)
% Implements the EGM96 gravity model.
%
...
if isfield(data,'gravity')
    if isfield(data.gravity,'degree')
        [a(1,1), a(2,1), a(3,1)] = gravitysphericalharmonic( r', 'EGM96', data.gravity.degree);
    end
else
    [a(1,1), a(2,1), a(3,1)] = gravitysphericalharmonic( r', 'EGM96');
end
