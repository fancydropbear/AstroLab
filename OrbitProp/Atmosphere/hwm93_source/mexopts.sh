...
#
            ...
            FLIBS="$MLIBS -L$FC_LIBDIR -lgfortran"
            FOPTIMFLAGS='-O'
            FDEBUGFLAGS='-g'
#
            LD="$CC"
...
#
            ...
            FFLAGS="-fexceptions"
            FC_LIBDIR="/usr/local/lib"
            FLIBS="$MLIBS -L$FC_LIBDIR -weak-lgfortran"
            FOPTIMFLAGS='-O'
            FDEBUGFLAGS='-g'
#
            LD="$CC"
            LDEXTENSION='.mexmaci'
            LDFLAGS="-static-libgfortran -static-libgcc -bundle -Wl,-flat_namespace -undefined suppress -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE"
